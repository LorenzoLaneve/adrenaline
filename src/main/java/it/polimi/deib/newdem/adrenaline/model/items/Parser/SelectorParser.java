...
public class SelectorParser {
    ...
    private TileSelectorFactory parseDirectionalTileSelector(JsonObject jsonEffectObject) {
        ...
        String sourceTilePositionString = jsonEffectObject.get("sourceTilePosition").getAsString();

        JsonElement jsonEffectElement = new JsonParser().parse(sourceTilePositionString);
        JsonObject sourceTilePositionObject = jsonEffectElement.getAsJsonObject();

        int x = sourceTilePositionObject.get("x").getAsInt();

        int y = sourceTilePositionObject.get("y").getAsInt();
        ...
        return new DirectionalTileSelectorFactory(tilePosition, minDist, maxDist, ignoreWalls);
    }
    ...
    private PlayerSelectorFactory parseDirectionalPlayerSelector(JsonObject jsonEffectObject) {
        ...
        return new DirectionalPlayerSelectorFactory(sourcePlayer, ignoreWalls);
