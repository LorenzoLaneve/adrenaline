...
public class TileDamageEffect extends ConcreteEffect {
    ...
    public void apply(EffectVisitor visitor) throws UndoException {
        ...
        Tile selectedTile = visitor.getTile(selectorMaker.makeSelector(visitor));

        for (Player player : selectedTile.getPlayers()) {
