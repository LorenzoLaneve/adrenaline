...
public class TestWhisperEffect {
    ...
    Player player3;
    Player player4;
    WhisperVisitor visitor;
    Game game;
    int counter;
    int effectsCounter;

    public class WhisperVisitor extends EffectVisitorBase{

        public WhisperVisitor(){
            super();
        }
    ...
    public void setUp() throws Exception {
        ...
        TilePosition tilePosition3 = new TilePosition(0,0);
    ...
    public void testApply() {
        ...
        WhisperEffect effect = new WhisperEffect();
