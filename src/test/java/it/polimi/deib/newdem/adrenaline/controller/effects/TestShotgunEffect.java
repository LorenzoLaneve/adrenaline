...
public class TestShotgunEffect {
    ...
    Player player3;
    Player player4;
    ShotgunVisitor visitor;
    Game game;
    int counter;
    int effectsCounter;

    public class ShotgunVisitor extends EffectVisitorBase{

        public ShotgunVisitor(){
            super();
        }
    ...
    public void testApplyFirstChoice() {
        ...
        ShotgunEffect effect = new ShotgunEffect();
