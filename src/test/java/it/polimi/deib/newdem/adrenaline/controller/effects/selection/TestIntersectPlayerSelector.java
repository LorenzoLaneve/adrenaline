...
public class TestIntersectPlayerSelector {
    ...
    public void isSelectable() {
        ...
        NearPlayerSelector nearPlayerSelector = new NearPlayerSelector(player1, 1,3);
        VisiblePlayerSelector visiblePlayerSelector = new VisiblePlayerSelector(player1);

        IntersectPlayerSelector unionPlayerSelector = new IntersectPlayerSelector(nearPlayerSelector, visiblePlayerSelector);

        assertTrue(unionPlayerSelector.isSelectable(map, player2));
        assertFalse(unionPlayerSelector.isSelectable(map, player3));
