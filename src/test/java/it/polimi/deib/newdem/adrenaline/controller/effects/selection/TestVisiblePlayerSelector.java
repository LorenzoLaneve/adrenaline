...
public class TestVisiblePlayerSelector {
    ...
    public void isSelectable() {
        ...
        VisiblePlayerSelector selc = new VisiblePlayerSelector(player1);


        assertTrue(selc.isSelectable(map, player2));
        assertFalse(selc.isSelectable(map,player3));
    }
}