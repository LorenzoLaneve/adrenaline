...
public class TestTagbackGrenadeEffect {

    EffectManager manager;
    TagbackGrenadeEffect effect;
    Map map;
    Player player1;
    Player player2;
    Player player3;
    ...
    public class TagbackContext implements EffectContext {
    ...
    public void setUp() throws Exception {
        ...
        context = new TagbackContext();

        manager = new EffectManager(context);
        effect = new TagbackGrenadeEffect();
