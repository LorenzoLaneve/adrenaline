...
public class TestSledgehammerEffect {
    Map map;
    Player player1;
    Player player2;
    Player player3;
    ...
    public void testApplyPayment() {
        ...
        assertEquals(map.getTile(new TilePosition(2,0)),player2.getTile());
    }
    ...
    public void testApplyNoPayment() {
        ...
        assertEquals(map.getTile(new TilePosition(0,0)),player2.getTile());
    }
}