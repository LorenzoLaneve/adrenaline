...
public class TestTargetingScopeEffect {

    EffectManager manager;
    TargetingScopeEffect effect;
    Map map;
    Player player1;
    Player player2;
    Player player3;
    ...
    public class TargetingScopeContext implements EffectContext {
    ...
    public void setUp() throws Exception {
        ...
        context = new TargetingScopeContext();

        manager = new EffectManager(context);
        effect = new TargetingScopeEffect();
