...
public class TestUnionTileSelector {
    ...
    public void isSelectable() {
        ...
        AnyDirectionalTileSelector anyDirectionalTileSelector = new AnyDirectionalTileSelector(player1.getTile(), 1,2, false);

        UnionTileSelector unionTileSelector = new UnionTileSelector(nearTileSelector, anyDirectionalTileSelector);

        assertTrue(unionTileSelector.isSelectable(map, player2.getTile()));
        assertTrue(unionTileSelector.isSelectable(map, player4.getTile()));
