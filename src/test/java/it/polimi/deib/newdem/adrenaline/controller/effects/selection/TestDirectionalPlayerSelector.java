...
public class TestDirectionalPlayerSelector {
    ...
    public void isSelectable() {
        ...
        DirectionalPlayerSelector noDir = new DirectionalPlayerSelector(player1, true);

        DirectionalPlayerSelector dir = new DirectionalPlayerSelector(player1, Direction.EAST, true);

        assertEquals(true, dir.isSelectable(map, player2));
        assertEquals(false, dir.isSelectable(map,player4));
        assertEquals(true, noDir.isSelectable(map, player4));
        assertEquals(false, noDir.isSelectable(map, player3));
