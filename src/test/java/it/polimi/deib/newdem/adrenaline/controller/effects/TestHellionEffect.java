...
public class TestHellionEffect {
    ...
    Player player3;
    Player player4;
    HellionVisitor visitor;
    HellionVisitorNoPayment visitorNoPayment;
    Game game;
    int counter;

    public class HellionVisitor extends EffectVisitorBase{

        public HellionVisitor(){
            super();
        }
    ...
    public class HellionVisitorNoPayment extends EffectVisitorBase{

        public HellionVisitorNoPayment(){
            super();
        }
    ...
    public void testApplyNoPayment(){
        ...
        visitorNoPayment = new HellionVisitorNoPayment();
