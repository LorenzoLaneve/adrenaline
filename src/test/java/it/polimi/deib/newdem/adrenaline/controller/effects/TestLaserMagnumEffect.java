...
public class TestLaserMagnumEffect {
    ...
    Player player3;
    Player player4;
    LaserMagnumVisitor visitor;
    LaserMagnumVisitorNoPayment visitorNoPayment;
    Game game;
    int counter;

    public class LaserMagnumVisitor extends EffectVisitorBase{

        public LaserMagnumVisitor(){
            super();
        }
    ...
    public class LaserMagnumVisitorNoPayment extends EffectVisitorBase{

        public LaserMagnumVisitorNoPayment(){
            super();
        }
    ...
    public void setUp() throws Exception {
        ...
        visitor = new LaserMagnumVisitor();
    ...
    public void testApplyPayment() {
        ...
        LaserMagnumEffect effect = new LaserMagnumEffect();
    ...
    public void testApplyNoPayment(){
        ...
        visitorNoPayment = new LaserMagnumVisitorNoPayment();
