...
public class TestLaserMagnumEffect {
    ...
    public class LaserMagnumContext implements EffectContext{
    ...
    public class LaserMagnumContextNoPayment implements EffectContext {
    ...
    public void setUp() throws Exception {
        ...
        manager = new EffectManager(new LaserMagnumContext());
    ...
    public void testApplyNoPayment(){
        ...
        managerNoPayment = new EffectManager(new LaserMagnumContextNoPayment());
